...
**Net revenue retention is below 100% after backfill completes** [../strategy/market_sizing.md](../strategy/market_sizing.md): an MSP that has onboarded all 41 environments drops from the backfill run-rate to ~$17,900/yr. **Growth after that point depends on the customer's own client growth**, which is coherent — petal 2 says we help them win clients — but it must be said rather than assumed.
