...
3. **The market is a wedge, not a category.** SAM is ~$215M at current pricing. Venture scale requires either capturing more of the labour value we displace — $6 captures about a quarter of the $22.50 blended cost per ticket [S27][S28] — or the internal-IT expansion, which is a fight on an axis we have chosen to avoid. *Mitigation: none yet. This is the honest ceiling.*
