...
**Market.** ~45,000 US MSPs, ~12,000 in the serviceable 10–100-employee band [S31]. **SAM ≈ $215M/yr** at a two-part tariff (~$6/resolved ticket plus a banded per-environment fee), against a US managed-services market of $120–140B [S31]. Steady-state ~$17,900/yr per MSP. **This is a wedge, not the whole market** — internal IT is roughly $288M more and this pack does not claim it, because entering it means competing on resolution quality, the axis we have chosen to avoid.
